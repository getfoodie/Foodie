...
class MeatWheelViewController: UIViewController {
    ...
    @IBOutlet weak var meatWheel: SwiftFortuneWheel!
    {
        ...
        var prizes = ["Pork", "Chicken", "Veal", "Soups", "Fast Food", "Desserts", "Carbs", "Ice Cream", "Noodles", "Rice"]
